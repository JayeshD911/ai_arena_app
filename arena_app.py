...
groq_client1   = OpenAI(api_key=os.getenv("GROQ_API_KEY"),
                            base_url="https://api.groq.com/openai/v1")

groq_client2   = OpenAI(api_key=os.getenv("GROQ_API_KEY"),
                            base_url="https://api.groq.com/openai/v1")
...
def battle(prompt):
    a = ask(groq_client1, "openai/gpt-oss-120b", prompt)
    b = ask(groq_client2, "llama-3.3-70b-versatile", prompt)
    return a, b
